...
document.getElementById('btn-add-fortune').onclick = () =>
  hand.addCard({id:`f${n++}`,type:'fortune',title:'Hack The System',
    body:'Instead of rolling the die, gain up to 6 passengers at end of turn.'});
document.getElementById('btn-add-crisis').onclick = () =>
  hand.addCard({id:`c${n++}`,type:'crisis',title:'Fuel Leak',
    body:'Roll the die twice. Remove fuel equal to or more than the sum.'});
...
requestAnimationFrame(() => {
  [
    {id:'c1',type:'fortune',title:'Crisis Averted',
     body:'Ignore the current crisis. Only playable during the resolution phase.'},
    {id:'u1',type:'fuel',title:'Fuel Canister',body:''},
